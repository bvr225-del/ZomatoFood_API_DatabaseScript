USE [MIDLAND]
GO
/****** Object:  StoredProcedure [dbo].[Usp_UpdateOrder]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_UpdateOrder]
GO
/****** Object:  StoredProcedure [dbo].[Usp_students_user]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_students_user]
GO
/****** Object:  StoredProcedure [dbo].[Usp_ProjectLevelLog]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_ProjectLevelLog]
GO
/****** Object:  StoredProcedure [dbo].[Usp_GetOrderById]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_GetOrderById]
GO
/****** Object:  StoredProcedure [dbo].[Usp_GetOrder]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_GetOrder]
GO
/****** Object:  StoredProcedure [dbo].[Usp_EmployeeLoginDetails]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_EmployeeLoginDetails]
GO
/****** Object:  StoredProcedure [dbo].[Usp_employee_details_new]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_employee_details_new]
GO
/****** Object:  StoredProcedure [dbo].[Usp_DeleteOrder]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_DeleteOrder]
GO
/****** Object:  StoredProcedure [dbo].[Usp_AddOrder_Without_Return]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_AddOrder_Without_Return]
GO
/****** Object:  StoredProcedure [dbo].[Usp_AddOrder]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[Usp_AddOrder]
GO
/****** Object:  StoredProcedure [dbo].[GetSurveyPageData]    Script Date: 16-05-2026 10:35:05 ******/
DROP PROCEDURE IF EXISTS [dbo].[GetSurveyPageData]
GO
/****** Object:  Table [dbo].[UserSurveyQueAns]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[UserSurveyQueAns]
GO
/****** Object:  Table [dbo].[Userdata]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[Userdata]
GO
/****** Object:  Table [dbo].[SurveyResults]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[SurveyResults]
GO
/****** Object:  Table [dbo].[sr123]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[sr123]
GO
/****** Object:  Table [dbo].[sample123]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[sample123]
GO
/****** Object:  Table [dbo].[ProjectLevelLog]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[ProjectLevelLog]
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[Orders]
GO
/****** Object:  Table [dbo].[mast_user]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[mast_user]
GO
/****** Object:  Table [dbo].[Mast_Employee_Details]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[Mast_Employee_Details]
GO
/****** Object:  Table [dbo].[Error_details]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[Error_details]
GO
/****** Object:  Table [dbo].[EmployeeDetails]    Script Date: 16-05-2026 10:35:05 ******/
DROP TABLE IF EXISTS [dbo].[EmployeeDetails]
GO
/****** Object:  Table [dbo].[customers]    Script Date: 16-05-2026 10:35:05 ******/
...
CREATE TABLE [dbo].[Orders](
 ...
 CONSTRAINT [PK__Orders__080E3775B3241F9A] PRIMARY KEY CLUSTERED 
(
	[orderid] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
CREATE TABLE [dbo].[ProjectLevelLog](
 ...
 CONSTRAINT [PK__ProjectL__3214EC079D61144B] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
GO
INSERT [dbo].[Orders] ([orderid], [ordername], [orderlocation]) VALUES (5006, N'watch', N'hyd')
GO
INSERT [dbo].[Orders] ([orderid], [ordername], [orderlocation]) VALUES (5007, N'Monitor', N'hyd')
GO
INSERT [dbo].[Orders] ([orderid], [ordername], [orderlocation]) VALUES (5009, N'Monitor', N'hyd123')
GO
INSERT [dbo].[Orders] ([orderid], [ordername], [orderlocation]) VALUES (6006, N'HeadSet-Vizag123', N'Vizag')
GO
INSERT [dbo].[Orders] ([orderid], [ordername], [orderlocation]) VALUES (7005, N'TV-HYD', N'HYD')
GO
INSERT [dbo].[Orders] ([orderid], [ordername], [orderlocation]) VALUES (8005, N'clock', N'vijayawada')
GO
SET IDENTITY_INSERT [dbo].[Orders] OFF
GO
SET IDENTITY_INSERT [dbo].[ProjectLevelLog] ON 
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (1, N'venkat', N'Information', N'OrdersController: Post Api method Excution Starts', CAST(N'2026-05-05T17:40:16.513' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (2, N'venkat', N'Information', N'Post Api method called with OrderName:tv', CAST(N'2026-05-05T17:40:16.607' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (3, N'venkat', N'Information', N'Post Api method called with OrderLocation:hyd', CAST(N'2026-05-05T17:40:16.633' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (4, N'venkat', N'Information', N'OrdersService: AddOrder method Excution Starts', CAST(N'2026-05-05T17:40:16.647' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (5, N'venkat', N'Information', N'OrdersRepository: AddOrder method Excution Starts', CAST(N'2026-05-05T17:40:16.670' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (6, N'venkat', N'Information', N'OrdersRepository: AddOrder method Excution Ended', CAST(N'2026-05-05T17:40:16.753' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (7, N'venkat', N'Information', N'OrdersRepository: AddOrder method Excution Ended and Insertedrecord is 7006', CAST(N'2026-05-05T17:40:16.773' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (8, N'venkat', N'Information', N'OrdersService: AddOrder method Excution Ended', CAST(N'2026-05-05T17:40:16.790' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (9, N'venkat', N'Information', N'OrdersController: Post Api method Excution Ends', CAST(N'2026-05-05T17:40:16.803' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (10, N'venkat', N'Information', N'OrdersController: delete Api method Excution Starts', CAST(N'2026-05-05T18:53:15.967' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (11, N'venkat', N'Information', N'delete Api method called with OrderId:7006', CAST(N'2026-05-05T18:53:16.003' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (12, N'venkat', N'Information', N'OrdersService: DeleteOrderById method Excution Starts', CAST(N'2026-05-05T18:53:16.010' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (13, N'venkat', N'Information', N'OrdersRepository: DeleteOrderById method Excution Starts', CAST(N'2026-05-05T18:53:16.020' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (14, N'venkat', N'Information', N'OrdersRepository: DeleteOrderById method Excution Ended', CAST(N'2026-05-05T18:53:16.060' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (15, N'venkat', N'Information', N'OrdersRepository: DeleteOrderById method Excution Ended', CAST(N'2026-05-05T18:53:16.063' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (16, N'venkat', N'Information', N'EmployeeServices: DeleteOrderById method Excution Ended', CAST(N'2026-05-05T18:53:16.070' AS DateTime))
GO
INSERT [dbo].[ProjectLevelLog] ([Id], [username], [LogLevel], [MessageTemplate], [LogDate]) VALUES (17, N'venkat', N'Information', N'delete Api method Execution Ended', CAST(N'2026-05-05T18:53:16.077' AS DateTime))
GO
